...
import '../../controller/indexedstack_controller.dart';
import '../../controller/login_out_controllers.dart';
        ...
        return Scaffold(
          ...
          body: SingleChildScrollView(
            child: Container(
              ...
              child: IndexedStack(
                index: indexedStackValController.indexedStackModel.indexedmodel,
                children: [
                  Column(
                    children: [
                      Form(
                                      ...
                                      ..onTap = () {
                                        setState(() {
                                          indexedStackValController
                                              .indexedStackModel.indexedmodel = 1;
                                        });
                                      },
                                  ),
                                ],
                                  ...
                                  TextSpan(
                                    ...
                                    recognizer: TapGestureRecognizer()
                                      ..onTap = () {
                                        setState(() {
                                          indexedStackValController
                                              .indexedStackModel.indexedmodel = 0;
                                        });
                                      },
                                  ),
                                ],
